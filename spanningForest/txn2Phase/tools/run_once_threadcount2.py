...
threadCount = [3, 5, 8, 10, 15, 20, 25, 30, 35, 40] # [30, 35, 40] # , 50, 60, 80] # , 100, 120, 160]
batchRanges = threadCount
import os
import sys
import subprocess
trials = 3
executables = ['rephaltST'] # ["seqMIS", "incMIS", "txnMIS", "paraMIS", "slowMIS"] # "MIS"
inputFiles = [ "3Dgrid_E_10000000"]  # ["randLocalGraph_J_5_10000000", "rMatGraph_J_5_10000000", "3Dgrid_J_10000000"]
#if len(sys.argv) > 1:
