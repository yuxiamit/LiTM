...
appConfig = [
    {
        ...
        'data':["rMatGraph_J_5_100000000", "3Dgrid_J_100000000"], # ["randLocalGraph_J_5_100000000", "rMatGraph_J_5_100000000", "3Dgrid_J_100000000"],
	'batchSize':500000,
    },
    {
        'name':'matching',
...
totalRes = {}
for app in appConfig[1:2]: # appConfig[-2:]: # [appConfig[3]]:
    appName = app['name']
